...
<!-- .slide: data-state="normal" id="visible-after" data-timing="20s" data-menu-title="Visible Part - After" -->
...
<!-- .slide: data-state="normal" id="vms-status-update" data-timing="20s" data-menu-title="VM Status Update" -->
## VM Status Update
<img alt="VMs status update sequence diagram" data-src="images/libvirt-event-chain.svg" style="width: 100%"/>


<!-- .slide: data-state="normal" id="vms-status-update" data-timing="20s" data-menu-title="VM Actions" -->
## VM Actions
